        ...
        unsafe fn new() -> Self {
            Self {
                ...
                delta_values: _mm_setr_epi8(
                    ...
                    0x10, b2i(0xc3), b2i(0xbf), b2i(0xbf), b2i(0xb9), b2i(0xb9),
                ),
                ...
                check_values: _mm_setr_epi8(
                    b2i(0x80), b2i(0x80), b2i(0x80), b2i(0x80), b2i(0xcf), b2i(0xbf), b2i(0xd5), 
                    b2i(0xa6), b2i(0xb5), b2i(0x86), b2i(0xd1), b2i(0x80), b2i(0xb1), b2i(0x80), 
                    b2i(0x91), b2i(0x80),
                ),
